...
const s: Record<string, React.CSSProperties> = {
  ...
  h1: { fontSize: 22, fontWeight: 800, color: "#1a472a", margin: 0, letterSpacing: "-0.3px" },
  h2: { fontSize: 16, fontWeight: 700, color: "#222", marginBottom: 14, letterSpacing: "-0.1px" },
  h3: { fontSize: 13, fontWeight: 700, color: "#555", marginBottom: 10 },
  ...
  statsBanner: {
    ...
    gap: 16,
    background: "linear-gradient(135deg, #eaf3ea, #f0f7f0)",
  ...
  btnPrimary: {
    ...
    fontSize: 14,
    cursor: "pointer",
    boxShadow: "0 2px 8px rgba(26,71,42,0.25)",
  },
  btnSecondary: {
    background: "#f0f2f5",
    color: "#444",
