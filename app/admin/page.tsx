...
const s: Record<string, React.CSSProperties> = {
  page: {
    minHeight: "100vh",
    background: "linear-gradient(160deg, #f0f2f5 0%, #e8ecf0 100%)",
    display: "flex",
  ...
  h3: { fontSize: 13, fontWeight: 700, color: "#444", marginBottom: 10 },
  ...
  btnPrimary: {
    ...
    fontSize: 14,
    cursor: "pointer",
    boxShadow: "0 2px 8px rgba(26,71,42,0.28)",
  },
  btnSecondary: {
    background: "#f4f6f8",
    color: "#555",
